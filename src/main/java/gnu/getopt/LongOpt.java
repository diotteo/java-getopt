...
public class LongOpt extends Object {
	...
	public static final int NO_ARGUMENT = 0; //the option takes no argument.
	public static final int REQUIRED_ARGUMENT = 1; //the option takes an argument that is required.
	public static final int OPTIONAL_ARGUMENT = 2; //the option takes an argument that is optional.
